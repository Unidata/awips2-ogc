...
/**
 * OGC Web Coverage Service SOAP service implementation
 * 
 * <pre>
 * SOFTWARE HISTORY
 * 
...
public class WcsImpl extends AbstractOwsService implements IWcsPortType {
    ...
    public Capabilities getCapabilitiesOperation(GetCapabilities body)
        ...
        try {
            ...
            statRecorder.recordRequest(System.currentTimeMillis(), duration,
                    ServiceType.WCS, OperationType.QUERY, success);
    ...
    public CoverageDescriptions describeCoverageOperation(DescribeCoverage body)
        ...
        EndpointInfo endInfo = getInfo();
        try {
            return provider.describeCoverage(endInfo, new DescCoverageRequest(
                    body));
    ...
    private void logRequestInfo(long durationNanos, boolean success,
        ...
        if (endInfo != null
            ...
            requestLog += "Duration of " + (durationNanos / 1000000000.0)
                    + "s.";
