 ...
 * ------------ ---------- ----------- --------------------------
 * Apr 02, 2013            bclement     Initial creation
 * 
 * </pre>
 * 
 * @author bclement
...
public abstract class CoverageTransform<D extends SimpleDimension, L extends SimpleLayer<D>> {
    ...
    public CoverageDescription transform(L layer, boolean summaryOnly)
            throws WcsException {
     ...
     * @throws WcsException
     */
    protected ReferencedEnvelope getHorizontal(L layer) throws WcsException {
