 ...
 * ------------ ---------- ----------- --------------------------
 * Sep,    2013            behemmi     Initial creation
 * May 23, 2014 3199       bclement    moved to edex.soap from edex.log
 * Nov 29, 2017 6166       nabowle     Update for Apache CXF 3.1.14
 *
 * </pre>
 *
 * @author behemmi
    ...
    public void handleMessage(Message message) throws Fault {
        if (writer != null
                || RequestLogController.getInstance().shouldLogRequestsInfo()
                        && log.isPriorityEnabled(RequestLogController
                                .getInstance().getRequestLogLevel())) {
            logging(message);
        }
    }
