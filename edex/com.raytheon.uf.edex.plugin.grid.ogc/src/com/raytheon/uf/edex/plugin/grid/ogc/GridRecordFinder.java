...
/**
 * Retrieves grid record metadata objects from the database using OGC metadata
 * 
 * <pre>
 * 
 * SOFTWARE HISTORY
...
public class GridRecordFinder {
    ...
    public static List<GridRecord> findWms(
        ...
        SortedSet<DataTime> times = ForecastTimeUtil.getDataTimes(l, time,
                dimensions);
    ...
    protected static String getIntDim(Map<String, String> dimensions,
            String key, GridLayer layer) throws OgcException {
    ...
    protected static Criterion getLevel(Map<String, String> dimensions,
            GridLayer layer) throws OgcException {
        String dimName = null;
    ...
    public static String ogcToDbParameter(String parameter) {
        return GridFieldAdapter.getNCEPFromCF(parameter);
    }
    ...
    public static String dbToOgcParameter(String parameter) {
        return GridFieldAdapter.getCFFromNCEP(parameter);
    }
}
